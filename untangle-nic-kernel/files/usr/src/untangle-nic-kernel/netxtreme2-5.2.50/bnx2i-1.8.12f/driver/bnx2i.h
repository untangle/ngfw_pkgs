...
#ifdef __RHEL54_DUAL_ISCSI_STACK__
#ifdef iscsi_free_session
#undef iscsi_free_session
#endif
#define iscsi_free_session	iscsi2_free_session

#ifdef iscsi_register_transport
#undef iscsi_register_transport
#endif
#define iscsi_register_transport	iscsi2_register_transport

#ifdef iscsi_unregister_transport
#undef iscsi_unregister_transport
#endif
#define iscsi_unregister_transport	iscsi2_unregister_transport

#ifdef iscsi_recv_pdu
#undef iscsi_recv_pdu
#endif
#define iscsi_recv_pdu		iscsi2_recv_pdu

#ifdef iscsi_block_session
#undef iscsi_block_session
#endif
#define iscsi_block_session	iscsi2_block_session

#ifdef iscsi_unblock_session
#undef iscsi_unblock_session
#endif
#define iscsi_unblock_session	iscsi2_unblock_session

#ifdef iscsi_destroy_conn
#undef iscsi_destroy_conn
#endif
#define iscsi_destroy_conn	iscsi2_destroy_conn

#ifdef iscsi_create_conn
#undef iscsi_create_conn
#endif
#define iscsi_create_conn(_cls_sess, cid)	\
		iscsi2_conn_setup(_cls_sess, sizeof(struct bnx2i_conn), cid)
		//iscsi2_create_conn(_cls_sess, sizeof(struct bnx2i_conn), cid)

#ifdef iscsi_create_session
#undef iscsi_create_session
#endif
#define iscsi_create_session(shost, it, tid)	\
		iscsi2_create_session(shost, it, sizeof(struct bnx2i_sess), tid)

#ifdef iscsi_remove_session
#undef iscsi_remove_session
#endif
#define iscsi_remove_session	iscsi2_remove_session

#ifdef iscsi_conn_error
#undef iscsi_conn_error
#endif
#define iscsi_conn_error	iscsi2_conn_error_event

#undef iscsi_hostdata
#define iscsi_hostdata		iscsi_host_priv
