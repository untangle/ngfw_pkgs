...
ssh www.metavize.com -lroot "rm /var/www.trial/metavize/pool/metavize/s/sophos-*"
ssh www.metavize.com -lroot "rm /var/www.trial/metavize/pool/metavize/v/virus-transform_*"
