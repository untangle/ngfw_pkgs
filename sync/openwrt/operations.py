...
sync.registrar.register_operation("restart-wireless", [""], ["/sbin/wifi"], 11, None)

sync.registrar.register_operation("restart-dhcp", [""], ["/etc/init.d/dnsmasq restart"], 11, None)

sync.registrar.register_operation("startup-scripts", [""], ["/etc/init.d/startup boot"], 12, None)
