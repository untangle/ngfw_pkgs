...
nft flush table ip   port-forwards
nft flush table ip6  port-forwards
...
nft flush table ip  web-filter
nft flush table ip6 web-filter
...
nft flush table ip  captive-portal
nft flush table ip6 captive-portal
...
nft flush table inet vote
nft flush table ip   vote
nft flush table ip6  vote
...
nft flush table inet filter-rules-sys
...
nft flush table inet access-rules-sys
...
nft flush table inet access-rules
