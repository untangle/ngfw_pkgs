    ...
    */
    ...
    public boolean handleShortcutKeys(long time, KeyEvent e, boolean pressed) {
        ...
        case KeyEvent.VK_ENTER:
            ...
            altDown = false;
            ((RdesktopFrame_Localised) canvas.getParent().getParent()).toggleFullScreen();
            break;
    ...
    class RdesktopMouseAdapter extends MouseAdapter {
        ...
        public void mousePressed(MouseEvent e) {
            if(e.getY() != 0) ((RdesktopFrame_Localised) canvas.getParent().getParent()).hideMenu();
    ...
    class RdesktopMouseMotionAdapter extends MouseMotionAdapter {
        ...
        public void mouseMoved(MouseEvent e) {
           ...
           //Input.last_mousemove = mTime;
            ...
            if(e.getY() == 0) ((RdesktopFrame_Localised) canvas.getParent().getParent()).showMenu();
