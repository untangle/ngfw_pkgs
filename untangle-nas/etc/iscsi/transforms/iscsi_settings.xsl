<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    <xsl:output method="text" omit-xml-declaration="yes" encoding="UTF-8" indent="no"/>
        ...
        <xsl:template match="iet">
            <xsl:text>#####   WARNING!!! - This configuration file generated by Untangle NAS. DO NOT MANUALLY EDIT.  #####  </xsl:text>
            <xsl:text>&#10; &#10; &#10;</xsl:text>
        ...
        <xsl:template name="targetSettings">
            ...
            <xsl:for-each select="Wthreads">
                <xsl:text>&#x9;Wthreads </xsl:text><xsl:value-of select="@value"/><xsl:text>&#10;</xsl:text>
            </xsl:for-each>
            <xsl:for-each select="QueuedCommands">
                <xsl:text>&#x9;QueuedCommands </xsl:text><xsl:value-of select="@value"/><xsl:text>&#10;</xsl:text>
            </xsl:for-each>
        </xsl:template>
