            ...
            <td style="" align="center">
                ...
                <xsl:choose>
                    <xsl:when test="position() = 1">
                        <a href="" onclick="addCurtain(); tinker_buildUPSEditForm('{@id}'); return false;"><xsl:attribute name="href">#</xsl:attribute><img src="/nas/images/icons/edit_icon.png" height="16" width="16" alt="edit" /></a>
                    ...
                    <xsl:when test="position() = last()">
                        ...
                        <xsl:if test="$ison = 1">
                            <img src="/nas/images/icons/on_icon.png" height="16" width="16" alt="on" />
                        </xsl:if>
                        <xsl:if test="$ison = 0">
                            <img src="/nas/images/icons/off_icon.png" height="16" width="16" alt="off" />
                        </xsl:if>
            ...
            <td style="" align="center">
                ...
                <xsl:choose>
                    <xsl:when test="position() = 1">
                        ...
                        <img src="/nas/images/icons/edit_icon.png" height="16" width="16" alt="edit" /></a>
                    </xsl:when>
                    <xsl:when test="position() = last()">
                        <xsl:variable name="ison" select="."/>  
