...
void nct6796d_set_gpio_use_sel(int cmd, int pin)
{
	...
	if (port >= 2 && port <= 5) {
		...
		if (cmd) {
			set_bit(tmp, (void *)&val);
		} else {
			clear_bit(tmp, (void *)&val);
		}

		outb(GPIO_USE_SEL, EFIR);
		outb(val, EFDR);
		nuvoton_leave_ext_mode();
	} else if (port >= 6 || port <= 8) {
                nuvoton_enter_ext_mode();
...
void nct6796d_set_gp_io_sel(int cmd, int pin)
{
	...
	if ((port >= 0 && port <= 8) && (bit < 8)) {
		...
		switch (port) {
		case 0:
			reg = NCT6796D_GPIO0 + GP_IO;
			nuvoton_access_device(LD8);
			break;
		case 1:
			reg = NCT6796D_GPIO1 + GP_IO;
			nuvoton_access_device(LD8);
			break;
		case 2:
			reg = NCT6796D_GPIO2 + GP_IO;
			nuvoton_access_device(LD9);
			break;
		case 3:
			reg = NCT6796D_GPIO3 + GP_IO;
			nuvoton_access_device(LD9);
			break;
		case 4:
			reg = NCT6796D_GPIO4 + GP_IO;
			nuvoton_access_device(LD9);
			break;
		case 5:
			reg = NCT6796D_GPIO5 + GP_IO;
			nuvoton_access_device(LD9);
			break;
		case 6:
			reg = NCT6796D_GPIO6 + GP_IO;
			nuvoton_access_device(LD7);
			break;
		case 7:
			reg = NCT6796D_GPIO7 + GP_IO;
			nuvoton_access_device(LD7);
			break;
		case 8:
			reg = NCT6796D_GPIO8 + GP_IO;
			nuvoton_access_device(LD7);
			break;
		}
...
void nct6796d_set_gp_lvl(int cmd, int pin)
{
	...
	if ((port >= 0 && port <= 8) && (bit < 8)) {
		...
		switch (port) {
		case 0:
			reg = NCT6796D_GPIO0 + GP_LVL;
			nuvoton_access_device(LD8);
			break;
		case 1:
			reg = NCT6796D_GPIO1 + GP_LVL;
			nuvoton_access_device(LD8);
			break;
		case 2:
			reg = NCT6796D_GPIO2 + GP_LVL;
			nuvoton_access_device(LD9);
			break;
		case 3:
			reg = NCT6796D_GPIO3 + GP_LVL;
			nuvoton_access_device(LD9);
			break;
		case 4:
			reg = NCT6796D_GPIO4 + GP_LVL;
			nuvoton_access_device(LD9);
			break;
		case 5:
			reg = NCT6796D_GPIO5 + GP_LVL;
			nuvoton_access_device(LD9);
			break;
		case 6:
			reg = NCT6796D_GPIO6 + GP_LVL;
			nuvoton_access_device(LD7);
			break;
		case 7:
			reg = NCT6796D_GPIO7 + GP_LVL;
			nuvoton_access_device(LD7);
			break;
		case 8:
			reg = NCT6796D_GPIO8 + GP_LVL;
			nuvoton_access_device(LD7);
			break;
		}
...
void nct6796d_set_gpi_inv(int cmd, int pin)
{
	...
	if ((port >= 0 && port <= 8) && (bit < 8)) {
		...
		switch (port) {
		case 0:
			reg = NCT6796D_GPIO0 + GPI_INV;
			nuvoton_access_device(LD8);
			break;
		case 1:
			reg = NCT6796D_GPIO1 + GPI_INV;
			nuvoton_access_device(LD8);
			break;
		case 2:
			reg = NCT6796D_GPIO2 + GPI_INV;
			nuvoton_access_device(LD9);
			break;
		case 3:
			reg = NCT6796D_GPIO3 + GPI_INV;
			nuvoton_access_device(LD9);
			break;
		case 4:
			reg = NCT6796D_GPIO4 + GPI_INV;
			nuvoton_access_device(LD9);
			break;
		case 5:
			reg = NCT6796D_GPIO5 + GPI_INV;
			nuvoton_access_device(LD9);
			break;
		case 6:
			reg = NCT6796D_GPIO6 + GPI_INV;
			nuvoton_access_device(LD7);
			break;
		case 7:
			reg = NCT6796D_GPIO7 + GPI_INV;
			nuvoton_access_device(LD7);
			break;
		case 8:
			reg = NCT6796D_GPIO8 + GPI_INV;
			nuvoton_access_device(LD7);
			break;
		}
