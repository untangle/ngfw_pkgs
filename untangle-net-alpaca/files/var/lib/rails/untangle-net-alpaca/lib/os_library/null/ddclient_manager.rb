#
# $HeadURL: svn://chef/work/pkgs/untangle-net-alpaca/files/var/lib/rails/untangle-net-alpaca/lib/os_library/ddclient_manager.rb $
...
#
class OSLibrary::Null::DdclientManager < OSLibrary::DdclientManager
  include Singleton
