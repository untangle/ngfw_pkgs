...
var _default = _selectable.default.extend({
  ...
  methods: {
    ...
    genProgress: function genProgress() {
      return this.$createElement(_transitions.VFabTransition, {}, [this.loading === false ? null : (0, _helpers.getSlot)(this, 'progress') || this.$createElement(_VProgressCircular.default, {
        props: {
