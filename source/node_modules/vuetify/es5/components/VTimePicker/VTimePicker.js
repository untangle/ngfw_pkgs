...
/* @vue/component */
  ...
  methods: {
    ...
    setPicker: function setPicker(picker) {
      if (picker === 'HOUR') this.selecting = _SelectingTimes.SelectingTimes.Hour;else if (picker === 'MINUTE') this.selecting = _SelectingTimes.SelectingTimes.Minute;else if (picker === 'SECOND' && this.useSeconds) this.selecting = _SelectingTimes.SelectingTimes.Second;
    },
