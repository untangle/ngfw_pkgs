...
var BaseSlideGroup = (0, _mixins.default)(_VItemGroup.BaseItemGroup, _mobile.default).extend({
  ...
  methods: {
    ...
    genNext: function genNext() {
      ...
      var slot = this.$scopedSlots.next ? this.$scopedSlots.next({}) : (0, _helpers.getSlot)(this, 'next') || this.__cachedNext;
    ...
    genPrev: function genPrev() {
      ...
      var slot = this.$scopedSlots.prev ? this.$scopedSlots.prev({}) : (0, _helpers.getSlot)(this, 'prev') || this.__cachedPrev;
      return this.$createElement('div', {
