...
# This class is responsible for writing /etc/untangle-netd/pre-network-hook.d/15-ethernet-media
# based on the settings object passed from sync-settings.py
class EthernetManager:
    ethernetMediaFilename = "/etc/untangle-netd/pre-network-hook.d/15-ethernet-media"
